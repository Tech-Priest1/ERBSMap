...
export const spawnLocations = [
  ...
  { id: 'hotelBear', x: 135, y: 465, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  ...
  // Beach
  { id: 'beachWolves1', x: 100, y: 495, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'beachChicken1', x: 95, y: 515, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'beachMutBear', x: 45, y: 535, icon: require('../assets/images/animals/6.6.png'), timerId: 'timer7', initialTimer: 260 },
  { id: 'beachBoar1', x: 145, y: 585, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'beachBoar2', x: 75, y: 560, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60},
  { id: 'beachBear1', x: 85, y: 580, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'beachBear2', x: 110, y: 600, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'beachWolves2', x: 170, y: 527, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  ...
  { id: 'ArcheryBear1', x: 105, y: 215, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  ...
  //school
  { id: 'schoolBear1', x: 195, y: 280, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  ...
  { id: 'schoolBear2', x: 245, y: 255, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'schoolbatl', x: 260, y: 280, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  { id: 'schoolWolves1', x: 230, y: 360, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'schoolBoar1', x: 289, y: 262, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'schoolMutBoar', x: 270, y: 390, icon: require('../assets/images/animals/3.3.png'), timerId: 'timer11', initialTimer: 150},
  //fire station
  ...
  { id: 'fireMutChicken', x: 400, y: 360, icon: require('../assets/images/animals/1.1.png'), timerId: 'timer10', initialTimer: 150 },
  //police station
  ...
  { id: 'policeChicken', x: 465, y: 175, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'policeBear', x: 490, y: 195, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'policeBat',x: 505, y: 280, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  ...
  { id: 'gasBear', x: 275, y: 135, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'gasChicken', x: 280, y: 150, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'gasWolves', x: 277, y: 110, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'gasMutBoar', x: 310, y: 70, icon: require('../assets/images/animals/3.3.png'), timerId: 'timer11', initialTimer: 150 },
  
  //alley
  { id: 'alleyChickens1', x: 351, y: 120, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'alleyChickens2', x: 350, y: 100, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  ...
  { id: 'templebat2', x: 675, y: 270, icon: require('../assets/images/animals/2.png'),  timerId: 'timer3', initialTimer: 30 },
  ...
  { id: 'templeBoar3', x: 670, y: 295,  icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'templeWolves', x: 675, y: 320  , icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'templeBear1', x: 580, y: 180, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'templeBear2', x: 675, y: 235, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'templeMutBear',x: 700, y: 280, icon: require('../assets/images/animals/6.6.png'), timerId: 'timer7', initialTimer: 260 },
  //stream
  { id: 'streamBoar1', x: 575, y: 360, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'streamBoar2', x: 600, y: 355, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  ...
  //pond
  { id: 'pondChicken1', x: 480, y: 380, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'pondBear1', x: 500, y: 375, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'pondBear2', x: 515, y: 470, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'pondWolves1', x: 530, y: 370, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'pondWolves2', x: 500, y: 445, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'pondChicken2', x: 535, y: 490, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  
  //hospital
  { id: 'hospitalChicken', x: 640, y: 515, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'hospitalBat2', x: 620, y: 530, icon: require('../assets/images/animals/2.png'),  timerId: 'timer3', initialTimer: 30 },
  { id: 'hospitalbat', x: 670, y: 490, icon: require('../assets/images/animals/2.png'),  timerId: 'timer3', initialTimer: 30 },
  { id: 'hospitalMutDogs', x: 695, y: 515, icon: require('../assets/images/animals/4.4.png'), timerId: 'timer9', initialTimer: 150 },
  { id: 'hospitalDogs', x: 600, y: 560, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  { id: 'hospitalWolves', x: 660, y: 545,  icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 }, 
  //factory
  { id: 'factoryMutWolves', x: 640, y: 730, icon: require('../assets/images/animals/5.5.png'), timerId: 'timer8', initialTimer: 260 },
  { id: 'factoryWolves1', x: 655, y: 625, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'factoryWolves2', x: 575, y: 785, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'factoryBear1',x: 660, y: 680, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'factoryBear2', x: 595, y: 760, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'factorybat1', x: 615, y: 735, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  ...
  { id: 'factoryDogs1', x: 590, y: 735, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  { id: 'factoryDogs2', x: 620, y: 635, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  { id: 'factoryChicken', x: 620, y: 710, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  //cemetery
  { id: 'cemeteryWolves',x: 475, y: 570, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  ...
  { id: 'cemeteryBear', x: 440, y: 550, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170  },
  { id: 'cemeteryChicken1', x: 450, y: 600, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'cemeteryChicken2', x: 555, y: 585, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'cemeteryMutChickens', x: 545, y: 645, icon: require('../assets/images/animals/1.1.png'), timerId: 'timer10', initialTimer: 150 },
  //chapel
  ...
  //dock
  { id: 'dockBear1', x: 460, y: 810, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'dockBear2', x: 398, y: 860, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'dockBear3', x: 395, y: 865, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'dockBoar1', x: 425, y: 760, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'dockBoar2', x: 460, y: 790, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60},
  { id: 'dockDogs',  x: 370, y: 810, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  { id: 'dockChicken', x: 450, y: 770, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'dockbat1', x: 480, y: 765, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  //warehouse
  { id: 'wareBear1', x: 285, y: 780, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'wareBear2', x: 290, y: 785, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'wareBoar1', x: 275, y: 750, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'wareBoar2', x: 355, y: 765, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'wareChicken', x: 375, y: 720, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'wareMutChicken', x: 350, y: 700, icon: require('../assets/images/animals/1.1.png'), timerId: 'timer10', initialTimer: 150 },
  { id: 'warebat1', x: 310, y: 760, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  //uptown
  { id: 'uptownMutDogs', x: 150, y: 685, icon: require('../assets/images/animals/4.4.png'), timerId: 'timer9', initialTimer: 150 },
  { id: 'uptownWolves1',x: 235, y: 685, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'uptownWolves2',x: 275, y: 640, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'uptownChicken1', x: 235, y: 725, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'uptownChicken2', x: 210, y: 655, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'uptownbat1', x: 170, y: 705, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  { id: 'uptownBoar1', x: 270, y: 665, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'uptownBoar2',x: 185, y: 625, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'uptownBear', x: 190, y: 720, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 }, 
  //forest
  { id: 'forestMutDogs', x: 335, y: 550, icon: require('../assets/images/animals/4.4.png'), timerId: 'timer9', initialTimer: 150 },
  { id: 'forestChicken1', x: 275, y: 550, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'forestChicken2', x: 285, y: 515, icon: require('../assets/images/animals/1.png'), timerId: 'timer1', initialTimer: 0 },
  { id: 'forestbat1', x: 255, y: 545, icon: require('../assets/images/animals/2.png'), timerId: 'timer3', initialTimer: 30 },
  { id: 'forestBear1', x: 245, y: 510, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'forestWolves1',x: 300, y: 490, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  { id: 'forestBoar1', x: 285, y: 565, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'forestBoar2', x: 270, y: 480, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'forestBoar3', x: 250, y: 465, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
