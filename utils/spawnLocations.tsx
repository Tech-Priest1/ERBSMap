...
export const spawnLocations = [
  ...
  //factory
  { id: 'factoryMutWolves', x: 645, y: 595, icon: require('../assets/images/animals/5.5.png'), timerId: 'timer8', initialTimer: 260 },
  { id: 'factoryBear1', x: 640, y: 635, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'factoryBear2', x: 530, y: 705, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'factoryBear3', x: 575, y: 785, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  { id: 'factoryWolves',x: 660, y: 680, icon: require('../assets/images/animals/5.png'), timerId: 'timer6', initialTimer: 110 },
  ...
  //dock
  { id: 'dockBear1', x: 460, y: 810, icon: require('../assets/images/animals/6.png'), timerId: 'timer2', initialTimer: 170 },
  ...
  { id: 'dockBoar1', x: 430, y: 835, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'dockBoar2', x: 445, y: 825, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  { id: 'dockDogs', x: 460, y: 790, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  ...
  //uptown
  { id: 'uptownDogs',x: 190, y: 620, icon: require('../assets/images/animals/4.png'), timerId: 'timer4', initialTimer: 30 },
  ...
  { id: 'uptownBoar2', x: 190, y: 720, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 }, 
  { id: 'uptownBoar3', x: 200, y: 735, icon: require('../assets/images/animals/3.png'), timerId: 'timer5', initialTimer: 60 },
  //forest
